...
# f_name_evo = "CMAES"
f_name_fit = "CMAES_low_rng_positive"
comments = ['CMAES reach thr = .5 low random positive ranking']
...
TRIALS_TOT = 1 #5
OBJ_RANGE_X = [0.01, 0.01]
OBJ_RANGE_Y = [0.01, 0.01]
...
for gen in range(GENERATIONS_TOT):
    ...
    for ind in range(POPULATION_SIZE):
        ...
        for t in range(TRIALS_TOT):
            ...
            # print("mean reward:" + str(np.mean(reward_trial)))
            # time.sleep(5)
