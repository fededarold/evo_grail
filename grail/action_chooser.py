...
class ActionChooser(object):
    ...
    def get_candidate_actions(self, n=20):
        ...
        :return: candidate_actions: a list of tuples of candidate actions. Each tuple contains 3 different angles 
        (one for each robot)
        """
        candidate_actions = []
        for i in range(n):
    ...
    @staticmethod
    def choose_action(candidate_actions):
